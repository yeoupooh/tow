...
start %PYTHON_HOME%\python rep-copy.py %_PROJECTNAME% %TOW_SETUP_HOME%\TracRepo\Projects\%TOW_TEST_PROJECT%\conf\trac-%TOW_PACKAGE%-%TOW_LANG%.ini.tpl "%TOW_TRAC_PRJ%\%1\conf\trac.ini"
...
trac-admin "%TOW_TRAC_PRJ%\%1" permission add admin TRAC_ADMIN
trac-admin "%TOW_TRAC_PRJ%\%1" permission add admin XML_RPC
