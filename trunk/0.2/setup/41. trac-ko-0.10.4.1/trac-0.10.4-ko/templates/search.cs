...
if:len(search.result) || len(search.quickjump) ?>
 ...
 <div id="notfound">일치하는 항목이 발견되지않았습니다.</div><?cs
/if ?>

<div id="help">
 <strong>참고:</strong> 검색기능을 사용하면서 도움이 필요하다면, <a href="<?cs
   var:trac.href.wiki ?>/TracSearch">TracSearch</a> 페이지를 참고하십시오.
</div>
