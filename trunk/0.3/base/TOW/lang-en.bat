...
if "%1"=="TRAC_ADMIN_PERM_ADDED" echo [TOW] Gave TRAC_ADMIN permission to admin account.
if "%1"=="XMLRPC_PERM_ADDED" echo [TOW] Gave XML_RPC permission to admin account.
